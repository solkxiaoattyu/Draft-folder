   ...
   */
		...
		loadImageSource( sourceIndex, loader ) {
			...
			const promise = Promise.resolve( sourceURI ).then( function ( sourceURI ) {
				...
				// Some locally served .glb files with embedded textures can fail if the
				// blob URL is revoked before the browser finishes image decoding.
				// Keep the object URL alive here so models remain renderable in dev.
				...
				console.warn( 'THREE.GLTFLoader: Falling back to placeholder texture for', sourceURI, error );
				...
				fallbackTexture.userData.mimeType = sourceDef.mimeType || getImageURIMimeType( sourceDef.uri );
